...
void upperPortion(double x, double y, double z,
  double xScale, double yScale, double zScale,
  double rotateX, double rotateY)
  {
    glPushMatrix();
...
void alley(double x, double y, double z,
  ...
  void pins(double x, double y, double z, double xScale, double yScale, double zScale, double rotateX, double explosion)
  {
    ...
    // head
    drawPins(x+5+(front/60),y+(front/120),z+111+(front/30),0.25*xScale,0.25*yScale,0.25*zScale,front,0);
    // twins
    drawPins(x+4-(twins/80),y+(twins/120),z+112.5+(twins/20),0.25*xScale,0.25*yScale,0.25*zScale,twins,0);
    drawPins(x+6+(twins/80),y+(twins/120),z+112.5+(twins/20),0.25*xScale,0.25*yScale,0.25*zScale,twins,0);
    //thirds
    drawPins(x+3+(thirds/100),y+(thirds/120),z+114+(thirds/15),0.25*xScale,0.25*yScale,0.25*zScale,thirds,0);
    drawPins(x+5-(thirds/120),y+(thirds/120),z+114+(thirds/15),0.25*xScale,0.25*yScale,0.25*zScale,thirds,0);
    drawPins(x+7-(thirds/100),y+(thirds/120),z+114+(thirds/15),0.25*xScale,0.25*yScale,0.25*zScale,thirds,0);
    //back
    drawPins(x+2-(back/120),y+(back/120),z+115.5+(back/12),0.25*xScale,0.25*yScale,0.25*zScale,back,0);
    drawPins(x+4+(back/120),y+(back/120),z+115.5+(back/12),0.25*xScale,0.25*yScale,0.25*zScale,back,0);
    drawPins(x+6-(back/120),y+(back/120),z+115.5+(back/12),0.25*xScale,0.25*yScale,0.25*zScale,back,0);
    drawPins(x+8+(back/120),y+(back/120),z+115.5+(back/12),0.25*xScale,0.25*yScale,0.25*zScale,back,0);
  }
  ...
  void double_lane(double x, double y, double z, double xScale, double yScale, double zScale, double rotateX, double rotateY, unsigned int floor_texture, unsigned int cieling_texture, unsigned int duct_texture)
  {
    ...
    upperPortion(x+16.5,y,z,4*xScale,1*yScale,10*zScale,0,180);
    ball_return_body(x+17,y,z-15, 10*xScale,10*yScale,10*zScale , 0, 180);
    upperPortion(x+16,y+3,z-30,3*xScale,0.5*yScale,5*zScale,0,180);
    ...
    upperPortion(x+33.5,y,z,2*xScale,1*yScale,5*zScale,0,180);
    ...
    for(i = -1; i < 8 ; i++)
    {
      drawDuct(x+(4*i)+1,30,z-4,1,1,1,0,0,duct_texture);
      for(j = 0; j < 30 ; j++)
      {
        k = 30 + (j / 5);
        topYpos(x+(4*i)+1,k,z+(4*j),1,1,1,0,0,cieling_texture);
      }
    }
  }
  ...
  void draw_Cube(double x, double y, double z, double xScale, double yScale, double zScale, double rotateX, double rotateY, unsigned int texture)
  {
